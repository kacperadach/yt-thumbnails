export default function PrivacyPolicy() {
  return (
    <div className="flex justify-center w-full my-8">
      <div className="font-regular text-base" style={{ width: "50%" }}>
        <div className="font-regular text-base">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Simple Thumbnail, the
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Simple Thumbnail.
              </p>
            </li>
            <li>
              <p>
